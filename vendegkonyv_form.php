...
<h2>Ezen az oldalon le tudják írni a véleményüket az oldalról, esetleg hibákat, amikkel használat közben futtottak bele.</h2>
...
<?php
    ...
    for($i=0; $i<count($sorok); $i++)
    {
        ...
        print ("<div style='margin:18px; background-color:#88888800; padding:8px;'>
